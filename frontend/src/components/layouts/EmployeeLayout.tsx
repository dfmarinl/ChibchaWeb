...
const EmployeeLayout: React.FC = () => {
  ...
  return (
    <div className='min-h-screen bg-secondary-50 flex'>
      <Sidebar role={USER_ROLES.EMPLOYEE} />
          ...
          <div className='flex items-center gap-4'>
            <div className='flex items-center gap-3 pl-4 border-l border-secondary-200'>
              <div className='text-right hidden sm:block'>
                <p className='text-sm font-medium text-secondary-900'>{user?.name || 'Empleado'}</p>
                <p className='text-xs text-secondary-500'>Soporte Técnico</p>
              </div>
